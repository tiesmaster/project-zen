...
"));
            ...
            // act
            var panden = sut.ParsePanden(xmlReader);
...
"));
        ...
        private GeometryPolygon FromWkt(string wkt)
        {
            var wktFormatter = WellKnownTextSqlFormatter.Create();
            return wktFormatter.Read<GeometryPolygon>(new StringReader(wkt));
        }
...
"));
            ...
            // act
            var verblijfsobjecten = sut.ParseVerblijfsobjecten(xmlReader);
...
"));
            ...
            // act
            var nummeraanduiding = sut.ParseNummeraanduidingen(xmlReader);
...
"));
            ...
            // act
            var openbareRuimte = sut.ParseOpenbareRuimten(xmlReader);
